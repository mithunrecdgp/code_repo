...
%CONVERTHIVE
(
SAMPLES=20160702 20160717 20160725 20160802 20160816 20160823, BRAND=GP,
INPATH =\\10.8.8.51\LV0\TANUMOY\DATASETS\FROM HIVE,
OUTPATH=\\10.8.8.51\LV0\TANUMOY\DATASETS\MODEL REPLICATION
);


*20160702 20160717 20160725 20160802 20160816 20160823;
...
%IMPUTE(LIBNAME=DATALIB, INPUTLIB=TA4U1R9, BRAND=GP, SAMPLES=20160702 20160717 20160725 20160802 20160816 20160823);
...
%APPEND(LIBNAME=DATALIB, INPUTLIB=TA4U1R9, BRAND=GP, SAMPLES=20160702 20160717 20160725 20160802 20160816 20160823);
...
/**/
/*SYMBOLGEN:  Macro variable PROP_RESPONDERS resolves to 0.0016550263*/
/*SYMBOLGEN:  Macro variable PROP_NONRESPONDERS resolves to 0.9983449737*/
/*%PUT &PROP_RESPONDERS &PROP_NONRESPONDERS;*/
/*0.0016550263 0.9983449737*/
/*%PUT &PROP_RESPONDERS_BAL &PROP_NONRESPONDERS_BAL;*/
...
/* RUN UNBALANCED PIECE OF ANALYSIS */
...
PROC EXPORT DATA=GP_EM_ALLCAMPAIGNS_COMBINED_3
			OUTFILE="Z:\TANUMOY\DATASETS\MODEL REPLICATION\GP_EM_ALLCAMPAIGNS_COMBINED_3.TXT"
            DBMS=DLM REPLACE;
     DELIMITER="|";
RUN;
