...
%IMPUTE(LIBNAME=DATALIB, INPUTLIB=TA4U1R9, BRAND=GP, 
		SAMPLES=266815 266304 265291 264531 262539 261960);
...
%APPEND(LIBNAME=DATALIB, INPUTLIB=TA4U1R9, BRAND=GP, SAMPLES=266815 266304 265291 264531 262539 261960);
...
PROC REG DATA=GP_EM_ALLCAMPAIGNS_BALANCED_3;
  MODEL RESPONDER =	NUM_TXNS_12MO_SLS
					...
					EMAILS_CLICKED_GP EMAILS_VIEWED_GP 
					/VIF;
  WHERE TRAINING=1;
RUN;
QUIT;
...
PROC LOGISTIC DATA=GP_EM_ALLCAMPAIGNS_BALANCED_3
  ...
  MODEL RESPONDER(EVENT='1')=   NUM_TXNS_12MO_SLS
								DIV_SHP_GP YEARS_ON_BOOKS
								GP_PROMOTIONS_RECEIVED_12MO DAYS_LAST_PUR_GP
								AVG_UNT_RTL DISCOUNT_PCT_12MO
								EMAILS_CLICKED_GP EMAILS_VIEWED_GP 
...
PROC SQL;
 SELECT COUNT(*) INTO: TRAINCOUNT FROM GP_EM_ALLCAMPAIGNS_COMBINED_4 WHERE TRAINING=1 AND ACTIVE_FLAG EQ 1;
QUIT;
...
PROC SQL;
 SELECT COUNT(*) INTO: TESTCOUNT FROM GP_EM_ALLCAMPAIGNS_COMBINED_4 WHERE TRAINING=0  AND ACTIVE_FLAG EQ 1;
QUIT;
