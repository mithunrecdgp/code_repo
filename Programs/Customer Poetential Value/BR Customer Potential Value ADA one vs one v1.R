...
br_data<-read.csv.ffdf(file="//10.8.8.51/lv0/Saumya/Datasets/br_dem_mail.csv",header = TRUE,VERBOSE = TRUE,
                       sep=',')

br_data<-read.csv(file="//10.8.8.51/lv0/Saumya/Datasets/br_dem_mail.csv",header = TRUE,
                       sep=',')
