...
at_data = np.genfromtxt('//10.8.8.51/lv0/Tanumoy/Datasets/Model Replication/at_recent_data.csv',
...
with open('//10.8.8.51/lv0/Tanumoy/Datasets/Python Attrition Models/at_recent_training.csv', 'w', 
          newline='') as fp:
...
for i in list(range(0,len(size_list))):
    ...
    for j in list(range(0,10)):
        ...
        for k in list(range(0,20)):
            ...
            with open('//10.8.8.51/lv0/Tanumoy/Datasets/Python Attrition Models/at_recent_training.csv', 'a', newline='') as fp:
                a = csv.writer(fp, delimiter=',')
