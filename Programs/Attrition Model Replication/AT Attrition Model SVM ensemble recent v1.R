...
at.data <-read.csv.ffdf(file="//10.8.8.51/lv0/Tanumoy/Datasets/Model Replication/at_recent_data.csv",
                        header = TRUE,VERBOSE = TRUE,  sep=',',colClasses = c(rep("numeric",14)))
...
write.table(cbind("Testing_No","Customer_Key","Actual_response",
            ...
            '//10.8.8.51/lv0/Tanumoy/Datasets/Model Replication/at_recent_ensemble_testing.csv',
...
for (j in 1:runs) 
{
  ...
  for (i in 1:20 )
  {
    ...
    load(paste0("//10.8.8.51/lv0/Tanumoy/Datasets/SVM_Models/AT/Recent/","model",i,".RData"))
  ...
  write.table(output,'//10.8.8.51/lv0/Tanumoy/Datasets/Model Replication/at_recent_ensemble_testing.csv', 
              append=TRUE,sep=",",row.names=FALSE,col.names=FALSE)
  
}


at.data <-read.csv.ffdf(file="//10.8.8.51/lv0/Tanumoy/Datasets/Model Replication/at_recent_ensemble_testing.csv",
