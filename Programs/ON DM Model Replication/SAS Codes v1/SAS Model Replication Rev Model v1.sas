...
PROC UNIVARIATE DATA=DATALIB.ON_ALLCAMPAIGNS_RESPONDERS;
VAR NET_SALES_AMT;
OUTPUT OUT=DATALIB.ON_NET_SLS_PROMO_PCTL
	   PCTLPRE = NET_SALES_AMT_
	   PCTLPTS= 0.5 50 99.5;
RUN;

DATA ON_ALLCAMPAIGNS_RESPONDERS_1;
KEEP NET_SALES_AMT AVG_ORD_SZ_12MO_CP ONSALE_QTY_12MO AVG_UNT_RTL_CP
	 UNITS_PER_TXN_12MO_SLS DIV_SHP_ON TREATMENT_GROUP RESPONDER
	 ONSALE_QTY_6MO DAYS_LAST_PUR_ON AVG_ORD_SZ_12MO END_DT START_DT
	 NET_SALES_AMT_12MO_RTN AVG_UNT_RTL NUM_TXNS_12MO_SLS WEEKEND_DAYS
	 ...
	 TESTING NUM_PLCC_TXNS_12MO_SLS WT ON_PROMOTIONS_RECEIVED_12MO;
...
DATA DATALIB.ON_NET_SLS_PROMO_PCTL; 
 SET DATALIB.ON_NET_SLS_PROMO_PCTL;
...
DATA ON_ALLCAMPAIGNS_RESPONDERS_2;
SET ON_ALLCAMPAIGNS_RESPONDERS_1;
...
DATA ON_ALLCAMPAIGNS_RESPONDERS_3;
SET ON_ALLCAMPAIGNS_RESPONDERS_2;
...
PROC REG DATA=ON_ALLCAMPAIGNS_RESPONDERS_3 OUTEST=DATALIB.ON_ALLCAMPAIGNS_REVEST;
 MODEL NET_SALES_AMT   =      AVG_ORD_SZ_12MO ONSALE_QTY_12MO  NET_SALES_AMT_12MO_SLS PLCC_TXN_PCT DIV_SHP_ON
							  AVG_UNT_RTL DISCOUNT_PCT_12MO YEARS_ON_BOOKS LENGTH_PROMO
							  ON_PROMOTIONS_RECEIVED_12MO/VIF;
 WHERE TRAINING=1 AND CAMPAIGN NE 230123;
 OUTPUT OUT=ON_ALLCAMPAIGNS_RESPONDERS_3_P
