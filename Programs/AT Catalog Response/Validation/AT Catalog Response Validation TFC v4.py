...
at_train_summary = pd.read_csv('//10.8.8.51/lv0/Tanumoy/Datasets/Model Results/Catalog Response Model/at_catalog_training_tfc_' + str(min(size_list)) + '_' + str(max(size_list)) + '_v4.txt',
                               sep='|', header=0)

at_test_summary  = pd.read_csv('//10.8.8.51/lv0/Tanumoy/Datasets/Model Results/Catalog Response Model/at_catalog_testing_tfc_' + str(min(size_list)) + '_' + str(max(size_list)) + '_v4.txt',
                               sep='|', header=0)
...
at_summary = at_summary.sort_values(by=['TestingAUC', 'TestingConcordance', 'cvAUC', 'Score'], 
                                    ascending=[0, 0, 0, 1])
...
aucmatrix.to_csv('//10.8.8.51/lv0/Tanumoy/Datasets/Model Results/Catalog Response Model/at_catalog_fall_validation_tfc.csv',
                 index=0, sep=',')