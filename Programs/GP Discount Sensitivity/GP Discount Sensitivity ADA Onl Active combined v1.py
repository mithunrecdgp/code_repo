...
with open('//10.8.8.51/lv0/Tanumoy/Datasets/Discount Sensitivity/gp_python_onl_active_combined_training.csv', 'w', 
          newline='') as fp:
...
for i in list(range(0,len(size_list))):
    ...
    for j in list(range(0,10)):
        ...
        for l in list(range(0,10)):
            ...
            modelfolderpath = "D:/Discount Sensitivity/Pickle/ADA_Onl_Active_combined/" + str(int(size)) + "_" + str(int(j+1)) +"_" + str(nu)        
            ...
            for k in list(range(0,20)):
                ...
                with open('//10.8.8.51/lv0/Tanumoy/Datasets/Discount Sensitivity/gp_python_onl_active_combined_training.csv', 'a', newline='') as fp:
                    a = csv.writer(fp, delimiter=',')
