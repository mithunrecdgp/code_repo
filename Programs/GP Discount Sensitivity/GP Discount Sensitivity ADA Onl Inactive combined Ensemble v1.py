...
modelspath = '//10.8.8.51/lv0/Tanumoy/Datasets/Discount Sensitivity/gp_python_onl_inactive_combined_best_models.csv'
...
for i in list(range(0, num_models)):
    ...
    currentmodelpath = 'D:/Discount Sensitivity/Pickle/ADA_Onl_Inactive_combined/' + currentmodelfolder + '/' + currentmodelname
...
with open('//10.8.8.51/lv0/Tanumoy/Datasets/Discount Sensitivity/gp_python_onl_inactive_combined_ensemble.csv', 'w', 
          newline='') as fp:
...
with open('//10.8.8.51/lv0/Tanumoy/Datasets/Discount Sensitivity/gp_python_onl_inactive_combined_ensemble.csv', 'a', newline='') as fp:
    a = csv.writer(fp, delimiter=',')
    data = [[outputmatrix]]
