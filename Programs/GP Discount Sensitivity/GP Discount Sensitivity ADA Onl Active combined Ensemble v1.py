...
path = '//10.8.8.51/lv0/Tanumoy/Datasets/Discount Sensitivity/GP_OnlineActive_1st_2nd_combined.csv'
...
modelspath = '//10.8.8.51/lv0/Tanumoy/Datasets/Discount Sensitivity/gp_python_onl_active_combined_best_models.csv'
...
for i in list(range(0, num_models)):
    ...
    currentmodelpath = 'D:/Discount Sensitivity/Pickle/ADA_Onl_Active_combined/' + currentmodelfolder + '/' + currentmodelname
...
print('----------------------------------------------------------------------------')
print(' Exporting Unadjusted Probabilities from ADA/SAMME Models to an external file ')
print('----------------------------------------------------------------------------')

   
with open('//10.8.8.51/lv0/Tanumoy/Datasets/Discount Sensitivity/gp_python_onl_active_combined_ensemble.csv', 'w', 
          newline='') as fp:
...
with open('//10.8.8.51/lv0/Tanumoy/Datasets/Discount Sensitivity/gp_python_onl_active_combined_ensemble.csv', 'a', newline='') as fp:
    a = csv.writer(fp, delimiter=',')
    data = [[outputmatrix]]
    a.writerows(outputmatrix)
