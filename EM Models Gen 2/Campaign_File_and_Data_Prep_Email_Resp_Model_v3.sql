hadoop fs -put gp_email_universe.csv /user/xtghosh/gp_email_universe


--SET GLOBAL VARIABLES AND CREATE DATABASE;

SET CAMPAIGN_VERSION = 1679576; SET CURRENT_BRAND = GP; SET CURRENT_COUNTRY = US;

SET CAMPAIGN_VERSION = 1714234; SET CURRENT_BRAND = GP; SET CURRENT_COUNTRY = US;

SET CAMPAIGN_VERSION = 1876838; SET CURRENT_BRAND = GP; SET CURRENT_COUNTRY = US;

SET CAMPAIGN_VERSION = 1897094; SET CURRENT_BRAND = GP; SET CURRENT_COUNTRY = US;

SET CAMPAIGN_VERSION = 1933662; SET CURRENT_BRAND = GP; SET CURRENT_COUNTRY = US;

SET CAMPAIGN_VERSION = 1943469; SET CURRENT_BRAND = GP; SET CURRENT_COUNTRY = US;
...
SET CAMPAIGN_VERSION = 1753192; SET CURRENT_BRAND = ON; SET CURRENT_COUNTRY = US;

SET CAMPAIGN_VERSION = 1796150; SET CURRENT_BRAND = ON; SET CURRENT_COUNTRY = US;

SET CAMPAIGN_VERSION = 1941732; SET CURRENT_BRAND = ON; SET CURRENT_COUNTRY = US;
...
DROP TABLE IF EXISTS GP_EMAILABLE;
CREATE TABLE GP_EMAILABLE
(CUSTOMER_KEY BIGINT,
BRAND STRING,
LIST_NAME BIGINT,
SCORE DOUBLE,
...
LOCATION '/user/xtghosh/gp_uk_fullfile_20170821'
...
SELECT DISTINCT
CAMPAIGN_VERSION, CUSTOMER_KEY, TO_DATE(EVENT_DATE) AS EVENT_DATE
FROM MDS_NEW.ODS_MAILINGEMAIL_T
