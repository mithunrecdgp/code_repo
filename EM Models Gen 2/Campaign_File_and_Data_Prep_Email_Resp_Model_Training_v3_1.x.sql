hadoop fs -put gp_email_universe.txt /user/xtghosh/gp_email_model/gp_email_universe


--SET GLOBAL VARIABLES AND CREATE DATABASE;

SET CAMPAIGN_VERSION = 20170917; SET CURRENT_BRAND = GP; SET CURRENT_COUNTRY = US; SET START_DT = 2017-09-17; SET END_DT = 2017-09-23; 
...
DROP TABLE IF EXISTS ${hiveconf:CURRENT_BRAND}_EM_${hiveconf:CAMPAIGN_VERSION}.${hiveconf:CURRENT_BRAND}_${hiveconf:CAMPAIGN_VERSION}_MAILED_0;
CREATE TABLE ${hiveconf:CURRENT_BRAND}_EM_${hiveconf:CAMPAIGN_VERSION}.${hiveconf:CURRENT_BRAND}_${hiveconf:CAMPAIGN_VERSION}_MAILED_0
(
BRAND STRING,
LIST_NAME BIGINT,
SCORE FLOAT,
...
LINES TERMINATED BY '\n'
LOCATION '/user/xtghosh/gp_email_model/gp_email_universe'
TBLPROPERTIES ('serialization.null.format' = '');

SELECT * FROM ${hiveconf:CURRENT_BRAND}_EM_${hiveconf:CAMPAIGN_VERSION}.${hiveconf:CURRENT_BRAND}_${hiveconf:CAMPAIGN_VERSION}_MAILED_0 LIMIT 100;
...
SELECT DISTINCT
CASE WHEN CUSTOMER_KEY > 0 THEN ${hiveconf:CAMPAIGN_VERSION} ELSE NULL END AS CAMPAIGN_VERSION,
LIST_NAME, CUSTOMER_KEY, TO_DATE(EVENT_DATE) AS EVENT_DATE,
CASE WHEN CUSTOMER_KEY > 0 THEN EVENT_DATE ELSE NULL END AS START_DT,
CASE WHEN CUSTOMER_KEY > 0 THEN DATE_ADD(TO_DATE(EVENT_DATE), -1 + 7) ELSE NULL END AS END_DT
FROM ${hiveconf:CURRENT_BRAND}_EM_${hiveconf:CAMPAIGN_VERSION}.${hiveconf:CURRENT_BRAND}_${hiveconf:CAMPAIGN_VERSION}_MAILED_0;
...
SELECT
T1.CUSTOMER_KEY,
COUNT(DISTINCT T4.CAMPAIGN_VERSION) AS EMAILOPENS
FROM 
${hiveconf:CURRENT_BRAND}_EM_${hiveconf:CAMPAIGN_VERSION}.${hiveconf:CURRENT_BRAND}_${hiveconf:CAMPAIGN_VERSION}_MAILED_1 T1
INNER JOIN
(
SELECT DISTINCT T2.CUSTOMER_KEY, TO_DATE(T2.EVENT_DATE) AS EVENT_DATE,  T2.CAMPAIGN_VERSION, T2.CELL_KEY, A4.CAMPAIGN_ID, A5.CAMPAIGN_OBJECTIVE
FROM 
MDS_NEW.ODS_EMAILOPENS_T T2
LEFT OUTER JOIN
MDS_NEW.ODS_CELL_T A4
ON T2.CELL_KEY = A4.CELL_KEY
LEFT OUTER JOIN
MDS_NEW.ODS_CAMPAIGN_T A5
ON A4.CAMPAIGN_ID = A5.CAMPAIGN_ID
WHERE 
T2.BRAND = '${hiveconf:CURRENT_BRAND}' AND T2.EVENT_TYPE = 'V' AND A5.CAMPAIGN_OBJECTIVE != 'T' AND
UNIX_TIMESTAMP(TO_DATE(T2.EVENT_DATE), 'yyyy-MM-dd') BETWEEN
...
SELECT
T1.CUSTOMER_KEY,
COUNT(DISTINCT T4.CAMPAIGN_VERSION) AS EMAILCLICKS
FROM 
${hiveconf:CURRENT_BRAND}_EM_${hiveconf:CAMPAIGN_VERSION}.${hiveconf:CURRENT_BRAND}_${hiveconf:CAMPAIGN_VERSION}_MAILED_1 T1
INNER JOIN
(
SELECT DISTINCT T2.CUSTOMER_KEY, TO_DATE(T2.CLICK_DATE) AS CLICK_DATE,  T2.CAMPAIGN_VERSION, T2.CELL_KEY, A4.CAMPAIGN_ID, A5.CAMPAIGN_OBJECTIVE
FROM 
...
ON A4.CAMPAIGN_ID = A5.CAMPAIGN_ID
WHERE 
T2.BRAND = '${hiveconf:CURRENT_BRAND}' AND A5.CAMPAIGN_OBJECTIVE != 'T' AND
UNIX_TIMESTAMP(TO_DATE(T2.CLICK_DATE), 'yyyy-MM-dd') BETWEEN
UNIX_TIMESTAMP('${hiveconf:START_DT}', 'yyyy-MM-dd') AND UNIX_TIMESTAMP('${hiveconf:END_DT}', 'yyyy-MM-dd')
) T4
ON 
T1.CUSTOMER_KEY = T4.CUSTOMER_KEY
...
SELECT
T1.*, COALESCE(T2.EMAILOPENS, 0) AS EMAILOPENS, COALESCE(T3.EMAILCLICKS, 0) AS EMAILCLICKS,
CASE WHEN T2.EMAILOPENS  > 0 THEN 1 ELSE 0 END AS EMAILOPENFLAG,
CASE WHEN T3.EMAILCLICKS > 0 THEN 1 ELSE 0 END AS EMAILCLICKFLAG
FROM
${hiveconf:CURRENT_BRAND}_EM_${hiveconf:CAMPAIGN_VERSION}.${hiveconf:CURRENT_BRAND}_${hiveconf:CAMPAIGN_VERSION}_MAILED_0 T1
LEFT OUTER JOIN
...
(
(UNIX_TIMESTAMP(TO_DATE(T1.SHIP_DATE),'yyyy-MM-dd') BETWEEN 
 UNIX_TIMESTAMP(DATE_SUB('${hiveconf:START_DT}', 7 + 365 - 1), 'yyyy-MM-dd')  AND 
 UNIX_TIMESTAMP(DATE_SUB('${hiveconf:START_DT}', 7), 'yyyy-MM-dd')  AND 
 T1.ORDER_STATUS = 'R'
) OR
(UNIX_TIMESTAMP(TO_DATE(T1.DEMAND_DATE), 'yyyy-MM-dd') BETWEEN
 UNIX_TIMESTAMP(DATE_SUB('${hiveconf:START_DT}', 7 + 365 - 1), 'yyyy-MM-dd')  AND 
...
(
CASE 
WHEN T1.BRAND = 'BR' AND INSTR(UPPER(T2.MDSE_DIV_DESC), 'ACCESSORIES') > 0 THEN 'ACCESSORIES'
...
WHEN T1.BRAND = 'BR' AND INSTR(UPPER(T2.MDSE_DIV_DESC), 'PETITE') > 0 THEN 'PETITES'
WHEN T1.BRAND = 'GP' AND INSTR(UPPER(T2.MDSE_DIV_DESC), 'ACCESS') > 0 THEN 'ACCESSORIES'
WHEN T1.BRAND = 'GP' AND INSTR(UPPER(T2.MDSE_DIV_DESC), 'BABY') > 0 THEN 'KIDSBABY'
...
WHEN T1.BRAND = 'GP' AND INSTR(UPPER(T2.MDSE_DIV_DESC), 'KID') > 0 THEN 'KIDSBABY'
WHEN T1.BRAND = 'GP' AND INSTR(UPPER(T2.MDSE_DIV_DESC), 'MATERNITY') > 0 THEN 'MATERNITY'
WHEN T1.BRAND = 'ON' AND INSTR(UPPER(T2.MDSE_DIV_DESC), 'ACCESS') > 0 THEN 'ACCESSORIES'
WHEN T1.BRAND = 'ON' AND INSTR(UPPER(T2.MDSE_DIV_DESC), 'ACESS') >0 THEN 'ACCESSORIES'
WHEN T1.BRAND = 'ON' AND INSTR(UPPER(T2.MDSE_DIV_DESC), 'BABY') > 0 THEN 'KIDSBABY'
...
WHEN T1.BRAND = 'ON' AND INSTR(UPPER(T2.MDSE_DIV_DESC), 'PETITE') > 0 THEN 'PETITES'
...
WHEN T1.BRAND = 'ON' AND INSTR(UPPER(T2.MDSE_DIV_DESC), 'KID') > 0 THEN 'KIDSBABY'
WHEN T1.BRAND = 'ON' AND INSTR(UPPER(T2.MDSE_DIV_DESC), 'MATERNITY') > 0 THEN 'MATERNITY'
ELSE 'MISC'
END 
) AS MDSE_DIV_DESC
FROM 
...
FROM
(
SELECT DISTINCT CUSTOMER_KEY FROM ${hiveconf:CURRENT_BRAND}_${hiveconf:CAMPAIGN_VERSION}_MAILED
) T0
LEFT OUTER JOIN
...
CUSTOMER_KEY,
EVENT_DATE,
COALESCE(EMAILOPENS, 0),
COALESCE(EMAILOPENFLAG, 0),
COALESCE(EMAILCLICKS, 0),
