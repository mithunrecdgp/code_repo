...
SET CAMPAIGN_VERSION = 2033109; SET CURRENT_BRAND = GP; SET CURRENT_COUNTRY = US; SET SISTER_CAMPAIGN_VERSION = (2033109);

SET CAMPAIGN_VERSION = 2034203; SET CURRENT_BRAND = GP; SET CURRENT_COUNTRY = US; SET SISTER_CAMPAIGN_VERSION = (2034203);

SET CAMPAIGN_VERSION = 2033804; SET CURRENT_BRAND = GP; SET CURRENT_COUNTRY = US; SET SISTER_CAMPAIGN_VERSION = (2033804, 2033802);
...
(
(UNIX_TIMESTAMP(T1.SHIP_DATE,'yyyy-MM-dd') BETWEEN 
 UNIX_TIMESTAMP(DATE_SUB(T3.START_DT, 7 + 365), 'yyyy-MM-dd')  AND 
 UNIX_TIMESTAMP(DATE_SUB(T3.START_DT, 7), 'yyyy-MM-dd')  AND 
 T1.ORDER_STATUS = 'R'
) OR
...
WHERE 
TO_DATE(T2.OPEN_DATE)  <= DATE_SUB(T3.START_DT, 7) AND 
(
TO_DATE(EST_CLOSED_DT) IS NULL OR 
TO_DATE(EST_CLOSED_DT) >= DATE_SUB(T3.START_DT, 7)
);
