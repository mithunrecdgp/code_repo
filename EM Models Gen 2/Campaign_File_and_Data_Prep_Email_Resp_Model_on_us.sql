...
SET CAMPAIGN_VERSION = 1941732; SET CURRENT_BRAND = ON; SET CURRENT_COUNTRY = US; SET SISTER_CAMPAIGN_VERSION = (1941732);

SET CAMPAIGN_VERSION = 1914405; SET CURRENT_BRAND = ON; SET CURRENT_COUNTRY = US; SET SISTER_CAMPAIGN_VERSION = (1914404);

SET CAMPAIGN_VERSION = 1817402; SET CURRENT_BRAND = ON; SET CURRENT_COUNTRY = US; SET SISTER_CAMPAIGN_VERSION = (1817402);

SET CAMPAIGN_VERSION = 1942814; SET CURRENT_BRAND = ON; SET CURRENT_COUNTRY = US; SET SISTER_CAMPAIGN_VERSION = (1942814);

SET CAMPAIGN_VERSION = 1953954; SET CURRENT_BRAND = ON; SET CURRENT_COUNTRY = US; SET SISTER_CAMPAIGN_VERSION = (1953953, 1953952);

SET CAMPAIGN_VERSION = 1998486; SET CURRENT_BRAND = ON; SET CURRENT_COUNTRY = US; SET SISTER_CAMPAIGN_VERSION = (1998488, 1998489, 1998487);

SET CAMPAIGN_VERSION = 2011390; SET CURRENT_BRAND = ON; SET CURRENT_COUNTRY = US; SET SISTER_CAMPAIGN_VERSION = (2011390);
